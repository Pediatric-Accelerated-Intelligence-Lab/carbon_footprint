...
"""NVFlare job.py (FAST): no slowdown for any client.

- sleep_ms_mean=0, sleep_ms_std=0
- extra_no_update_iters=0

This mirrors the baseline behavior with no artificial delay.
"""
...
if __name__ == "__main__":
    ...
    for i in range(n_clients):
        sim = "--sleep_ms_mean=0 --sleep_ms_std=0 --extra_no_update_iters=0"
    ...
    job.simulator_run("runHigh", gpu="0")
